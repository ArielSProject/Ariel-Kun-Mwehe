...
// Fake Reply
//FAKEREPLY PRODUCT
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 99999999999,status: 200, thumbnail: log0, surface: 200, message: `Hallo Kak ${m.pushName}`, orderTitle: 'Ariel SP', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
//FAKEREPLY LOCATION
const flokasi = {
key : {
...
case prefix+'thunder':{
  ...
  break
case prefix+'ytmp3':{
if (!q) return reply(`Example ${command} https://youtu.be/zXLfPENjJWM`)
ads(mess.wait)
let peakali = await fetchJson(`https://ariel-api-aespibotz.herokuapp.com/api/download/ytmp3?url=${q}`)
sock.sendMessage(m.chat, { audio: { url: peakali.result.url }, mimetype: 'audio/mpeg' }, { quoted: ftroli })
}
break
case prefix+'ytmp4':{
if (!q) return reply(`Example ${command} https://youtu.be/zXLfPENjJWM`)
ads(mess.wait)
let peakali4 = await fetchJson(`https://ariel-api-aespibotz.herokuapp.com/api/download/ytmp4?url=${q}`)
sock.sendMessage(m.chat, { video: { url: peakali4.result.url }, caption: `Dowmload By ariel-api-aespibotz.herokuapp.com/api/download/ytmp4?url=${q}` }, { quoted: ftroli })
}
break
...
break
case prefix+'attp': {
const buff = await getBuffer(`https://ariel-api-aespibotz.herokuapp.com/api/maker/attp?text=${encodeURIComponent(q)}`)
...
case prefix+'list':
            ...
            const arielkece12 = `Hii Kak *${m.pushName}*

Silahkan Klick Button Dibawah Untuk Melihat Beberapa List Yang Tersedia Di Group *${groupName}*`
...
const arielkecesp = `Hii Kak *${m.pushName}*
